    ...
    <body >
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  ...
		  <ul class="nav navbar-nav">
				...
				<li><a href="./pages/whydon.php" >Why Donate Blood?</a></li>
				<li><a href="./pages/whyneed.php" >Why Needs Blood?</a></li>
				<li><a href="./pages/signup.php" >Login</a></li>
			</ul>
			...
			<div class="container-fluit" >
				...
				<div class="row"><!--row-->
						...
						<div class="col-md-3">
							...
							<form role="form" action="./pages/result.php" method="get">
								<div class="form-group">
									...
									<select class="form-control" name="blood" style="">
									...
									<input type="submit" name="search" value="search" class="form-control btn btn-info" id="sign">
									</form>
									</div>
								</div>
								...
								<div class="col-md-3">
									...
									<a href="./pages/form.php"><button type="button" class="btn btn-primary" name="search">Registration</button></a>
									</div>
